...
// Using the modern experimental namespace for better reliability
import { crypto } from 'k6/experimental/crypto';
...
export default function () {
  ...
  // 4. Use the experimental crypto sign method
  const signature = crypto.sign("RSA-SHA256", PRIVATE_KEY_PEM, rawString);
  ...
  console.log(`[Status]: ${res.status} | [MAC]: ${mpiMac}`);
}
